...
import AddressModel from '../models/Adresses';
...
async function setupCollection(){
    try{
        ...
        console.log("Checking contacts index is exists...")
        await ContactModel.syncIndexes();
        console.log("'contacts' collection and index has been created")

        // Check index of address 
        console.log("Checking address index is exists...")
        await AddressModel.syncIndexes();
        console.log("'addresses' collection and index has been created")
